...
#define OLED_DC_MASK     0x20   // pin60
#define OLED_CS_MASK     0x10   // pin59
#define OLED_RST_MASK    0x40   // pin61
...
*/
    ...
    GPIOPinWrite(GPIOA0_BASE, OLED_CS_MASK, 0);
    GPIOPinWrite(GPIOA0_BASE, OLED_DC_MASK, 0);

    MAP_SPIDataPut(GSPI_BASE, c);

    MAP_SPICSDisable(GSPI_BASE);
    MAP_SPIDataGet(GSPI_BASE, &temp);
    GPIOPinWrite(GPIOA0_BASE, OLED_CS_MASK, OLED_CS_MASK);
...
*/
    ...
    MAP_SPICSEnable(GSPI_BASE);
    GPIOPinWrite(GPIOA0_BASE, OLED_CS_MASK, 0);
    GPIOPinWrite(GPIOA0_BASE, OLED_DC_MASK, OLED_DC_MASK);
...
*/
  ...
  GPIOPinWrite(GPIOA0_BASE, OLED_RST_MASK, 0);   // RESET = RESET_LOW

  for(delay=0; delay<100; delay=delay+1);// delay minimum 100 ns

  GPIOPinWrite(GPIOA0_BASE, OLED_RST_MASK, OLED_RST_MASK);    // RESET = RESET_HIGH
